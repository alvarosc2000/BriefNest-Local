    ...
    <main className="relative min-h-screen bg-[#0f172a] text-white font-inter overflow-x-hidden">
      ...
      <section className="relative z-10 py-20 px-6 md:px-20 lg:px-40 text-center bg-[#0f172a] border-t border-white/10">
        ...
        <p className="text-gray-300 max-w-3xl mx-auto mb-12">
          Otros generadores producen briefs genéricos o de SEO. 
          BriefMind es distinto: crea{" "}
          <span className="font-semibold text-white">
            documentos estratégicos completos
          </span>, listos para ejecución real.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <FeatureCard
            title="🧠 Enfoque Estratégico"
            text="Incluye insights de consumidor, narrativa creativa, diferenciación y matriz táctica."
          />
          <FeatureCard
            title="📊 Operativo y Accionable"
            text="Cada deliverable tiene rol en el funnel. Incluye KPIs, riesgos y benchmarking competitivo."
          />
          <FeatureCard
            title="🌍 Bilingüe y Premium"
            text="Genera briefs en inglés o español, con tono ejecutivo y estándar internacional."
          />
        </div>
      </section>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-[#0c1a33] text-cyan-300">
                ...
                <th className="p-4">Otras apps</th>
                <th className="p-4">BriefMind</th>
              </tr>
            </thead>
            <tbody>
              {[
          ...
          {plans.map((plan) => (
            ...
            >
              ...
              <p className="text-gray-300 mb-1">
                {plan.briefsIncluded} briefs incluidos
              </p>
              <p className="text-gray-400 mb-4">
                Extra: {plan.pricePerExtraBrief}
              </p>
